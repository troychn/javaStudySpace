package com.troylc.java.xml.readXml.parserxml;

import com.troylc.java.xml.readXml.parserxml.entity.Book;
import com.troylc.java.xml.readXml.parserxml.handler.SAXParserHandler;
...
public class ParseTest {
	...
	public void domXmlParser() {
		...
		try {
			...
			Document document = db.parse(ParseTest.class.getClass().getResourceAsStream
					("/com/my/java/xml/readXml/books.xml"));
	...
	public void saxXmlParser(){
		...
		try {
			...
			parser.parse(ParseTest.class.getClass().getResourceAsStream
					("/com/my/java/xml/readXml/books.xml"), handler);
		} catch (ParserConfigurationException e) {
			e.printStackTrace();
		} catch (SAXException e) {
			e.printStackTrace();
	...
	public void jdomXmlParser() {
		...
		try {
			...
			in = ParseTest.class.getClass().getResourceAsStream("/com/my/java/xml/readXml/books.xml");
	...
	public void dom4jXmlParser(){
		...
		try {
			org.dom4j.Document document = reader.read(ParseTest.class.getClass().getResourceAsStream
					("/com/my/java/xml/readXml/books.xml"));
