package com.troylc.nettyDemo.dao;
...
public interface DeviceInfoDao extends JpaRepository<DmpDeviceInfoEntity,String> {
    /**
     ...
     *********************************************************************************
     */
    @Query(value = "select di from DmpDeviceInfoEntity di " +
            "where di.serialnumber = :serialNo")
    public DmpDeviceInfoEntity findBySerialNoAndVersion(@Param("serialNo") String serialNo) throws Exception;
}
